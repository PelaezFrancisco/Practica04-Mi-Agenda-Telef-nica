...
<br><hr>
 <form id="formulario01" method="POST"  action="../../controladores/usuario/modificarT.php">
 <h2> Modificar Telefono a Usuarios </h2>
 <br>
 <input type="hidden" id="codigo" name="codigo"  value="<?php echo $codigo ?>" />
 <label for="telefono">Telefono: </label>
 <input type="text" name="tel" id="tel" class="tel" value="<?php echo $row["tel_numero"] ;?>" onkeyup="validarTelefono(this)"/>
 <div id="mensaje5" class="mensaje"></div>
 <br><br>
 <label for="tipo">Tipo:</label>
 <input type="text" id="tipo" name="tipo" value="<?php echo $row["tel_tipo"] ;?>" required placeholder="Ingrese el tipo de celular ..." />
 <br><br>
 <label for="operador">Operador:</label>
 <input type="text" id="operador" name="operador" value="<?php echo $row["tel_operadora"] ;?>" required placeholder="Ingrese la operadora ..."/>
 <br><br>
